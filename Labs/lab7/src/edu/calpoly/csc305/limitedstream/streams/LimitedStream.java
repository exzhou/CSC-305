...
public interface LimitedStream<T> {
  /**
   * Produces a stream containing ony those elements that satisfy the
   * provided predicate.
  ...
  /**
   * Produces a stream with at most the specified number of elements.
   * This is an intermediate operation.
   *
  ...
  /**
   * Produces a stream with elements mapped by the provided function.
   * This is an intermediate operation.
   *
  ...
  /**
   * Returns a count of the number of elements in the stream.
  ...
  /**
   * Gathers the elements of the underlying stream into a list.
   * This is a terminal operation.
   *
